...
namespace ChessLogic
{
    public class Board
    {
        ...
        private bool IsKingBishopVKingBishop(Counting counting)
        {
            ...
            Position wBishopPos = FindPieces(Player.White, PieceType.Bishop);
            Position bBishopPos = FindPieces(Player.Black, PieceType.Bishop);

            return wBishopPos.SquareColor() == bBishopPos.SquareColor();
        }

        private Position FindPieces(Player color, PieceType type)
        {
